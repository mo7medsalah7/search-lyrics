  ...
  return (
    <div className="mainCard shadow-xl p-4 border-pink-500 border-solid border-b-2">
      <div className="grid grid-cols-2">
        <p className="col-start-1 col-end-2 md:font-medium sm:font-light">
          {track.track.track_name}
        </p>

        <div className="col-start-2 flex  bg-gray-200 bg-opacity-50 md:rounder-md lg:rounded-lg sm:rounder-sm px-2 py-1">
